...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            ...
            <p>Rédigez et publiez un nouvel article sur <strong>SenArticle</strong></p>
        </div>
        ...
        <form action="{{ route('articles.store') }}" method="post" enctype="multipart/form-data" class="auth-form">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    placeholder="Ex: Les nouvelles tendances du numérique au Sénégal"
                    required
                    autofocus
                >
                @error('titre')
    ...
    {{-- Afficher le message global des erreurs de validation --}}
    @if ($errors->any())
